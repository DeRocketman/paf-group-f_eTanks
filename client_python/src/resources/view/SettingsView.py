...
class Ui_settingsView(object):
    def setupUi(self, settingsView):
        ...
        settingsView.resize(1200, 850)
        sizePolicy = QSizePolicy(QSizePolicy.Fixed, QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(settingsView.sizePolicy().hasHeightForWidth())
        settingsView.setSizePolicy(sizePolicy)
        settingsView.setStyleSheet(u"background: #8A8557;")
        self.showMainMenuButton = QPushButton(settingsView)
        ...
        self.writeChangesButton = QPushButton(settingsView)
        ...
        self.moveUpButton = QPushButton(settingsView)
        ...
        self.moveDownButton = QPushButton(settingsView)
        ...
        self.moveRightButton = QPushButton(settingsView)
        ...
        self.moveLeftButton = QPushButton(settingsView)
        ...
        self.mainWeaponButton = QPushButton(settingsView)
        ...
        self.secondaryWeaponButton = QPushButton(settingsView)
        ...
        self.setDefaultButton = QPushButton(settingsView)
        ...
        self.musicVolLcd = QLCDNumber(settingsView)
        ...
        self.soundVolLcd = QLCDNumber(settingsView)
    ...
    def retranslateUi(self, settingsView):
        self.showMainMenuButton.setText(QCoreApplication.translate("settingsView", u"Zur\u00fcck", None))
        self.writeChangesButton.setText(QCoreApplication.translate("settingsView", u"speichern", None))
        self.moveUpButton.setText(QCoreApplication.translate("settingsView", u"W", None))
        self.moveDownButton.setText(QCoreApplication.translate("settingsView", u"S", None))
        self.moveRightButton.setText(QCoreApplication.translate("settingsView", u"D", None))
        self.moveLeftButton.setText(QCoreApplication.translate("settingsView", u"A", None))
        self.mainWeaponButton.setText(QCoreApplication.translate("settingsView", u"N", None))
        self.secondaryWeaponButton.setText(QCoreApplication.translate("settingsView", u"M", None))
        self.label_5.setText(QCoreApplication.translate("settingsView", u"move up", None))
        self.label_6.setText(QCoreApplication.translate("settingsView", u"move left", None))
        self.label_7.setText(QCoreApplication.translate("settingsView", u"move down", None))
        self.label_8.setText(QCoreApplication.translate("settingsView", u"move right", None))
        self.label_9.setText(QCoreApplication.translate("settingsView", u"fire main", None))
        self.label_10.setText(QCoreApplication.translate("settingsView", u"fire sec", None))
        self.label.setText(QCoreApplication.translate("settingsView", u"Sound", None))
        self.soundOnButton.setText(QCoreApplication.translate("settingsView", u"An", None))
        self.label_2.setText(QCoreApplication.translate("settingsView", u"Hintergrundmusik", None))
        self.musicOnButton.setText(QCoreApplication.translate("settingsView", u"An", None))
        self.label_4.setText(QCoreApplication.translate("settingsView", u"Sound-Lautst\u00e4rke", None))
        self.label_3.setText(QCoreApplication.translate("settingsView", u"Musik-Lautst\u00e4rke", None))
        self.setDefaultButton.setText(QCoreApplication.translate("settingsView", u"Standard", None))
        pass
    # retranslateUi
